...
public class Ex3Ahead {
    ...
    public static void main(String[] args) {
        ...
        while (!stop1) {
            counter = 1;              // resetting vars used by loops
            stop2 = false;            //
                    ...
                    while (!stop2) {
                        ...
                        if (in.hasNextInt()) {
                            ...
                            if (inp2 < 1) {
                                ...
                                diceVal1 = diceRoll();                 // recording first rolls of dice for the first check
                                diceVal2 = diceRoll();
                                if (inp2 == 1 && inp == (diceVal1+diceVal2)) {       // checking if user is fantastically lucky
                                    ...
                                    while (counter2 <= inp2) {                // main loop that emulates two dice
